...
namespace SaveIt.Data.Migrations
{
    ...
    [Migration("20231216105524_MigUsersRoles")]
    partial class MigUsersRoles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaveIt.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SaveIt.Models.PinTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SaveIt.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SaveIt.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SaveIt.Models.PinTag", b =>
                {
                    ...
                    b.HasOne("SaveIt.Models.Tag", "Tag")
                        .WithMany("PinTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
